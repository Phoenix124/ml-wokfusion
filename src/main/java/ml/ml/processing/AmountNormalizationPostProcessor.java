...
/**
 * Normalize numbers to ${symbol_pound}.00 pattern. Adds 0 in front of dot sign if missed.
...
public class AmountNormalizationPostProcessor implements Processor<IeDocument> {
    ...
    private NumberNormalizer numberNormalizer = new OcrAmountNormalizer();
    ...
    public void process(IeDocument document) {
        final Collection<Field> fields = document.findFields(this.fieldName);
